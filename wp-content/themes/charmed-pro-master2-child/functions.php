<?php
/*Ce fichier fait partie decharmed-pro-master2-child, charmed-pro-master2 child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function charmed_pro_master2_child_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'charmed_pro_master2_child_enqueue_child_styles' );
